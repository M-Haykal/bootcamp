                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card card-plain mt-8">
                            <div class="card-header pb-0 text-left bg-transparent">
                                <h3 class="font-weight-bolder text-info text-gradient">Welcome To Register</h3>
                            ...
                            <div class="card-body">
                                <form role="form" method="POST" action="{{ route('register_user') }}">
                                    ...
                                    <label>Name</label>
                                    <div class="mb-3">
                                        <input type="text" name="nama" class="form-control" placeholder="Name" aria-label="nama"
